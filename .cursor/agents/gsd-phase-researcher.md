...
@/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/references/thinking-models-research.md
...
```bash
node "/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
