...
The keys live in `.claude/settings.json` (project) or `/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/settings.json` (global) — **not** in `.planning/config.json`:
