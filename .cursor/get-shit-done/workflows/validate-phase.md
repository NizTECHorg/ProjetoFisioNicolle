...
```
Agent(
  prompt="Read /home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/templates/VALIDATION.md`
