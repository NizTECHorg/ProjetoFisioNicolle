...
Key references:
- @/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/references/ui-brand.md (display patterns)
- @/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/USER-PROFILE.md" "/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/references/user-profiling.md`
...
Reference: @/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .cursor/rules/" -- "Add profile to /home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/.cursor/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/.cursor/rules/"
...
```bash
BACKUP_PATH="/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/USER-PROFILE.backup.md"
```
...
Your profile:    /home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/skills/gsd-dev-preferences/SKILL.md
  ✓ .cursor/rules/ section       .cursor/rules/
  ✓ Global .cursor/rules/        /home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/.cursor/rules/
```
