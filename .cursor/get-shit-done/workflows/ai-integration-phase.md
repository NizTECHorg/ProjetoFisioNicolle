...
<required_reading>
@/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/references/ai-frameworks.md
@/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/agents/gsd-eval-planner.md for instructions.
