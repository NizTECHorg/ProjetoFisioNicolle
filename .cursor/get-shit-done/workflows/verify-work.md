...
<template>
@/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/workflows/transition.md`.
...
- Follow @/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/workflows/diagnose-issues.md
