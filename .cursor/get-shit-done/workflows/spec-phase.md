...
```bash
INIT=$(node "/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/templates/spec.md.
