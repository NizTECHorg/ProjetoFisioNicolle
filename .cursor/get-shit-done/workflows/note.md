...
- **Global scope**: `/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/notes/`)
...
2. Glob `/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/notes/` — works in any directory
