...
INSTALL_JS_GLOBAL="/home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/artur/Área de trabalho/ProjetoFisioNicolle/.cursor/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
